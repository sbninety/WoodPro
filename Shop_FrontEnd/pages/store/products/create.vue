...
const addMaterial = () => {
  product.materials.push({ name: null });
};
...
const addSize = () => {
  product.sizes.push({ length: null, width: null, height: null, price: null });
};
...
<template>
  <StoreLayout>
    <div class="bg-[#F6F6F6] h-full p-6">
      <div class="bg-white">
        <h3 class="text-xl font-bold pt-4 pl-4">Thêm Sản Phẩm</h3>
